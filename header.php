...
<title><?php echo $title = "Pokemon Psychic";?></title>
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_1.php'){?> class="active" <?php };?>><a href="page_1.php">Cantidad de Pokemon</a></li>
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_2.php'){?> class="active" <?php };?>><a href="page_2.php">Por porcentaje</a></li>
</ul>
</nav>
</div>
</div>
